...
<nav>
    <ul>
        ...
        <?= NavigationLink::generate('/index.php', 'Home', '/assets/icon/icon-home.png'); ?>
        <?= NavigationLink::generate('/leaderboards.php', 'Leaderboards', '/assets/icon/icon-leaderboards.png'); ?>
        <?= NavigationLink::generate('/documentation/', 'Dokumentation', '/assets/icon/icon-documentation.png'); ?>
