...
<p>
Du findest die Walo-Dokumentation im Server Ordner &rightarrow; plugins &rightarrow; Walo &rightarrow; <span class="code-inline">config.yml</span>. Die Standardkonfiguration sieht so aus (Walo-Plugin v3.0, Stand:&nbsp;02.09.2024):
</p>
<pre class="code">
...
<p>
Falls du einen <a href="https://support.discord.com/hc/en-us/articles/228383668-Intro-to-Webhooks">Discord-Webhook</a> einrichten willst, um automatisch Siege auf einem Discord Server anzeigen zu lassen, kannst du hier die Webhook-URL einfügen:
</p>
<pre class="code">
...
<p>
Die meisten dieser Optionen sind schon voreingerichtet, falls du das <a href="?article=Self-Hosting.php#dasvorgemachteserverpaketverwenden">Server-Paket</a> verwendet hast. Falls du den Server auf eigene Faust eingerichtet hast, solltest du aber alle dieser Einstellungen berücksichtigen.
</p>
...
<p>
Anti-XRay kann viel Performance vom Server beanspruchen. Falls es dir Probleme macht, kannst du in <span class="code-inline">spigot.yml</span> den Engine-Mode umschalten, bzw. Anti-XRay ganz ausstellen:
</p>
<pre class="code">
anti-xray:
  ...
...
<p>
Um TerrainControl die Kontrolle über die Walo-Welt zu geben (und somit Ozeane zu deaktivieren), musst du folgendes in <span class="code-inline">bukkit.yml</span> kopieren:
</p>
<pre class="code">
worlds:
  world:
...
<p>
Suche nach der Option <span class="code-inline">LandRarity</span> im Server Ordner &rightarrow; <span class="code-inline">plugins/TerrainControl/worlds/world/WorldConfig.ini</span> und passe diesen auf <span class="code-inline">100</span> an (deaktiviert den Ozean):
</p>
<pre class="code">
